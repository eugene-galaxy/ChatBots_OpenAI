  ...
  return (
    <div>
        ...
        <div>
          ...
          <ListGroup>
            ...
            <ListGroup.Item key="more_books">
              👋 Join our community &nbsp;
              <a
                href="https://discord.gg/Ut6F2m3T"
      ...
      {documents && documents.length === 0 && (
        <Alert color="failure">
          <span>
            <span className="font-medium">Index incomplete!</span> This index is
            not connected to a book. Please try to upload your book again{" "}
            <a
              href="https://www.steamship.com/build/ask-my-book-site"
              className="font-semibold text-gray-900 underline dark:text-white decoration-sky-500"
            >
              here
            </a>
